...
CAPABILITIES: list[dict[str, Any]] = [
    ...
    {
        "id": "auto_scan_session",
        "name": "Auto Scan Session",
        "category": "core",
        "module": "tools.core.auto_scan_session",
        "function": "run_auto_scan_session",
        "risk_level": "safe",
        "mutates_files": False,
        "needs_confirmation": False,
        "undo_strategy": "not_needed",
        ...
        "logs_action": True,
        "external_apps": ["wiztree", "smartctl"],
        "tags": ["core", "bot", "auto_scan", "advisor", "read_only"],
        "summary": "Collect a read-only machine snapshot for disk, storage, process, external app and audit state.",
    },
    {
        "id": "issue_classifier",
        "name": "Issue Classifier",
        "category": "core",
        "module": "tools.core.issue_classifier",
        "function": "run_issue_classifier",
        "risk_level": "safe",
        "mutates_files": False,
        "needs_confirmation": False,
        "undo_strategy": "not_needed",
        ...
        "logs_action": True,
        "external_apps": [],
        "tags": ["core", "classifier", "issues", "decision_layer", "read_only"],
        "summary": "Convert auto-scan snapshots into grouped issues and selectable bot action candidates.",
    },
    {
    ...
    {
        "id": "safe_delete_adapter",
        "name": "Safe Delete Adapter",
        "category": "core",
        "module": "tools.core.safe_delete_adapter",
        "function": "run_safe_delete_adapter",
        "risk_level": "medium",
        "mutates_files": True,
        "needs_confirmation": True,
        "undo_strategy": "recycle_bin",
        ...
        "logs_action": True,
        "external_apps": [],
        "tags": ["core", "delete_candidate", "safe_delete", "recycle_bin", "guarded_execution"],
        "summary": "Delete only selected delete_candidate items with risk=safe_delete, final token and Recycle Bin safety.",
    },
    {
        "id": "backup_adapter",
        "name": "Backup Adapter",
        "category": "core",
        "module": "tools.core.backup_adapter",
        "function": "run_backup_adapter",
        "risk_level": "medium",
        "mutates_files": True,
        "needs_confirmation": True,
        "undo_strategy": "not_needed",
        ...
        "logs_action": True,
        "external_apps": [],
        "tags": ["core", "needs_backup", "backup", "copy_only", "source_preserved", "guarded_execution"],
        "summary": "Copy selected needs_backup decisions to managed backups with final token; source files are preserved.",
    },
    {
    ...
    },
    {
        ...
        "name": "Bot Panel UI",
        "category": "ui",
        "module": "tools.ui.bot_panel",
        "function": "run_bot_panel",
        "risk_level": "medium",
        "mutates_files": True,
        "needs_confirmation": True,
        "undo_strategy": "recycle_bin",
        ...
        "logs_action": True,
        "external_apps": ["wiztree"],
        "tags": ["ui", "bot_panel", "assistant_dashboard", "selection_ui", "backup_flow", "move_later_flow", "safe_delete_flow"],
        "summary": "Assistant-first desktop UI for scan status, recommendations, preview/apply flows and advanced decision reports.",
    },
    {
        "id": "startup_scan",
        "name": "Startup Scan",
        "category": "core",
        "module": "tools.core.startup_scan",
        "function": "run_startup_scan",
        "risk_level": "safe",
        "mutates_files": False,
        "needs_confirmation": False,
        "undo_strategy": "not_needed",
        ...
        "logs_action": True,
        "external_apps": ["wiztree", "smartctl"],
        "tags": ["core", "boot", "startup", "advisor", "read_only"],
        "summary": "Boot entrypoint: full-drive read-only scan, issue classification and an advisory decision screen (skip/select/delete-all-safe).",
    },
    {
        "id": "startup_registration",
        "name": "Startup Registration",
        "category": "automation",
        "module": "tools.automation.startup_registration",
        "function": "run_startup_registration",
        "risk_level": "medium",
        "mutates_files": True,
        "needs_confirmation": False,
        "undo_strategy": "manual",
        ...
        "logs_action": True,
        "external_apps": [],
        "tags": ["automation", "startup", "autorun", "shell_startup"],
        "summary": "Enable or disable running the assistant boot scan automatically on Windows login via a removable Startup launcher.",
    },
    {
        "id": "startup_window",
        "name": "Startup Decision Window",
        "category": "ui",
        "module": "tools.ui.startup_window",
        "function": "run_startup_window",
        "risk_level": "medium",
        "mutates_files": True,
        "needs_confirmation": True,
        "undo_strategy": "recycle_bin",
        ...
        "logs_action": True,
        "external_apps": ["wiztree"],
        "tags": ["ui", "startup", "decision_inbox", "safe_delete_flow"],
        "summary": "Graphical boot Decision Inbox: scan, list safe-delete candidates and apply skip/select/delete-all with dry-run, confirm and Recycle Bin safety.",
    },
    {
