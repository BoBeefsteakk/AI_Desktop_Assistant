        ...
        "rules": [
            {
                ...
                "reason_text": "Chỉ file được Risk Classifier xếp safe_delete mới được đề xuất xóa.",
            },
            {
                ...
                "reason_text": "File review_required phải xem tay; không được đề xuất xóa mặc định.",
            },
            {
                "risk": PROTECTED,
                ...
                "plan_action": "keep",
                "can_recommend_delete": False,
                "reason_text": "File protected bị khóa và chỉ được giữ.",
            },
        ],
        "safety_contract": {
            "read_only": True,
