# Lưu trữ trạng thái dự án (lịch sử)

> Đây là **nhật ký lịch sử** của dự án (Phase 1–7), giữ lại để tra cứu. Trạng thái hiện
> hành xem ở [`PROJECT_STATUS.md`](PROJECT_STATUS.md); roadmap đang chạy ở
> [`PHASE8_ROADMAP.md`](PHASE8_ROADMAP.md). File này không cần đọc cho công việc hằng ngày.
